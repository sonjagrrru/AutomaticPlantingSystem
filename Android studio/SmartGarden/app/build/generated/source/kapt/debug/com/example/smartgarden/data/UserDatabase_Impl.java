...
public final class UserDatabase_Impl extends UserDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `user_data` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `firstname` TEXT NOT NULL, `lastname` TEXT NOT NULL, `age` INTEGER NOT NULL)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '9e530056f70e5eeb92e23d42fc044ee8')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        final HashMap<String, TableInfo.Column> _columnsUserData = new HashMap<String, TableInfo.Column>(4);
        ...
        _columnsUserData.put("lastname", new TableInfo.Column("lastname", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoUserData.equals(_existingUserData)) {
          return new RoomOpenHelper.ValidationResult(false, "user_data(com.example.smartgarden.data.User).\n"
                  + " Expected:\n" + _infoUserData + "\n"
                  + " Found:\n" + _existingUserData);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "9e530056f70e5eeb92e23d42fc044ee8", "affcb4787bd2bea8320d35ae2c1fbf64");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "user_data");
  }
